...
#define FILE_FCGI_STR_MSG		MSG_TYPE_MSG4
#define FILE_FCGI_NET_MSG		MSG_TYPE_MSG5
#define FILE_FCGI_RST_MSG		MSG_TYPE_MSG6
#define FILE_FCGI_REC_MSG		MSG_TYPE_MSG7
#define FILE_FCGI_OSD_MSG		MSG_TYPE_MSG8
#define FILE_FCGI_VIDEO_MSG	MSG_TYPE_MSG10
#define FILE_AV_MSG			MSG_TYPE_MSG9
#define FILE_UPNP_MSG		MSG_TYPE_MSG11
