...
//#include <../../include/nvp6158/nvp6158.h>
...
VI_DEV_ATTR_S DEV_ATTR_6114_1080P_2MUX_BASE =
{
    /*interface mode*/
    VI_MODE_BT656,
    /*work mode*/
...
//            s32Ret = SAMPLE_NVP6158_CfgV(enNorm, enWorkMode);
            if (s32Ret != HI_SUCCESS)
            {
...
//        case SAMPLE_VI_MODE_4_1080P:
		...
		case SAMPLE_VI_MODE_8_1080P:
//		case SAMPLE_VI_MODE_2_1080P:
			memcpy(&stViDevAttr,&DEV_ATTR_6114_1080P_2MUX_BASE,sizeof(stViDevAttr));
			SAMPLE_COMM_VI_SetMask(ViDev,&stViDevAttr);
			break;
        case SAMPLE_VI_MODE_16_720P:
            memcpy(&stViDevAttr,&DEV_ATTR_TP2823_720P_1MUX_BASE,sizeof(stViDevAttr));
...
//		printf("ViChn = %d\n",ViChn);
        if (SAMPLE_VI_MODE_4_1080P == enViMode
         ...
         || SAMPLE_VI_MODE_8_1080P == enViMode
