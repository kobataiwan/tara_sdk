...
void video_input_color_set(decoder_dev_ch_info_s *decoder_info)
{
	...
	{
		gpio_i2c_write(raptor3_i2c_addr[decoder_info->devnum], 0xff, 0x00 );
		gpio_i2c_write(raptor3_i2c_addr[decoder_info->devnum], 0x0c + decoder_info->ch, 0x00 );
		gpio_i2c_write(raptor3_i2c_addr[decoder_info->devnum], 0x10 + decoder_info->ch, 0x80 );
		gpio_i2c_write(raptor3_i2c_addr[decoder_info->devnum], 0x3c + decoder_info->ch, 0x80 );
		gpio_i2c_write(raptor3_i2c_addr[decoder_info->devnum], 0x40 + decoder_info->ch, 0x00 );
		gpio_i2c_write(raptor3_i2c_addr[decoder_info->devnum], 0x44 + decoder_info->ch, 0x00 );
		gpio_i2c_write(raptor3_i2c_addr[decoder_info->devnum], 0x48 + decoder_info->ch, 0x00 );
		gpio_i2c_write(raptor3_i2c_addr[decoder_info->devnum], 0x4c + decoder_info->ch, 0x00 );
		gpio_i2c_write(raptor3_i2c_addr[decoder_info->devnum], 0x50 + decoder_info->ch, 0x00 );
	}
